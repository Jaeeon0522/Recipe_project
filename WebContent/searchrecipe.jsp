...
<body>
	...
	<c:choose>
		<c:when test="${sessionScope.Recipe != null}">
			<div>
				<fieldset>
					<legend>My Page</legend>
					<div class="form-group">
						${sessionScope.Recipe.recipename}님 로그인 중
					</div>
		...
		<c:otherwise>
			...
			<form id=loginStyle method="post" action="./Searchrecipe.do">
				<fieldset>
					<legend>Recipe</legend>
					<div class="form-group">
						<label for="exampleInputEmail1">레시피</label> 
						<input type="text"
							class="form-control" id="exampleInputEmail1" placeholder="레시피"
							name="recipename">
					</div>
